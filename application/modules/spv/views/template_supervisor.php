...
<head>
    ...
    <script async src="https://www.googletagspv.com/gtag/js?id=G-GBZ3SGGX85"></script>
    <!-- js -->
    ...
    <!-- Google Tag spv (noscript) -->
    <noscript><iframe src="https://www.googletagspv.com/ns.html?id=GTM-NXZMQSS" height="0" width="0" style="display: none; visibility: hidden"></iframe></noscript>
    <!-- End Google Tag spv (noscript) -->
    <script>
    ...
    <script>
        (function(w, d, s, l, i) {
            ...
            var f = d.getElementsByTagName(s)[0],
                ...
                dl = l != "dataLayer" ? "&l=" + l : "";
            j.async = true;
            j.src = "https://www.googletagspv.com/gtm.js?id=" + i + dl;
            ...
            <div class="user-info-dropdown">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="<?= base_url('spv/Password/') ?>"><i class="dw dw-settings2"></i> Ganti Password</a>
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    <li class="dropdown">
                        <a href="<?= base_url('spv/Dashboard') ?>" class="dropdown-toggle no-arrow <?= $uri == 'Dashboard' ? 'active' : '' ?>">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            <li><a class="<?= $this->uri->segment(3) == 'list_approve_req' ? 'active ' : '' ?>" href="<?= base_url('spv/ApproveRequestTambah/list_approve_req') ?>">Approve Tambah Budget</a></li>
                            <li><a class="<?= $this->uri->segment(3) == 'list_approve' ? 'active ' : '' ?>" href="<?= base_url('spv/Approved/list_approve') ?>">Approved Plant Budget</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            <li>
                                <a class="<?= $this->uri->segment(3) == 'list_approve_trans' ? 'active ' : '' ?>" href="<?= base_url('spv/Approve_trans/list_approve_trans') ?>">Approval</a>
                            </li>
                            <li>
                                <a class="<?= $this->uri->segment(3) == 'histori_approve_trans' ? 'active ' : '' ?>" href="<?= base_url('spv/Approve_trans/histori_approve_trans') ?>">History</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            <li>
                                <a class="<?= $this->uri->segment(3) == 'list_approveVoucher' ? 'active ' : '' ?>" href="<?= base_url('spv/Approve_voucher/list_approveVoucher') ?>">Approve Plant</a>
                            </li>
                            <li>
                                <a class="<?= $this->uri->segment(3) == 'list_approve_lapor' ? 'active ' : '' ?>" href="<?= base_url('spv/Approve_voucher/list_approve_lapor') ?>">Approve Lapor Voucher</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            <li><a class="<?= $this->uri->segment(3) == 'panjer' ? 'active ' : '' ?>" href="<?= base_url('spv/Laporan/panjer') ?>">Panjar</a></li>
                            <li><a class="<?= $this->uri->segment(3) == 'payment' ? 'active ' : '' ?>" href="<?= base_url('spv/Laporan/payment') ?>">Payment Voucher</a></li>
                            <li><a class="<?= $this->uri->segment(2) == 'ReportBudget' ? 'active ' : '' ?>" href="<?= base_url('spv/ReportBudget') ?>">Plant Budget</a></li>
                            <li><a class="<?= $this->uri->segment(3) == 'apvoucher' ? 'active ' : '' ?>" href="<?= base_url('spv/Laporan/apvoucher') ?>">AP Voucher</a></li>
                        </ul>
                </ul>
            </div>
        </div>
