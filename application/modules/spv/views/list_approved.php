            ...
            <form id="form" name="form" method="post">
                <div class="pd-20">
                    <div class="form-inline">
                        ...
                        <button onclick="approveAll()" id="btn_delete_all" style="display:none ;" class="btn btn-success btn-sm mb-2 mr-2"> APPROVE DATA TERPILIH</button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <a href="<?= base_url('spv/Approved/approve?id_budget=' . $df->id_budget . '&kode=1') ?>" onclick="return confirm('Yakin approve ?')" class="badge badge-success">Approved</a>

                                            <a onclick="return confirm('Yakin reject ?')" href="<?= base_url('spv/Approved/approve?id_budget=' . $df->id_budget . '&kode=2') ?>" class="badge badge-danger">Reject</a>
...
<script>
    $(function() {
        ...
        $('#exampleModal').on("show.bs.modal", function(event) {
            ...
            // AJAX request
            $.ajax({
                url: "<?= base_url('spv/Approved/viewDetailPlant') ?>",
                type: 'post',
                data: {
                    id: userid
                },
    ...
    function rejectAll() {
        $("#form").attr("action", "<?= base_url('spv/Approved/multiReject') ?>");
        $("#form").submit();
    }

    function approveAll() {
        $("#form").attr("action", "<?= base_url('spv/Approved/multiApprove') ?>");
        $("#form").submit();
    }
</script>