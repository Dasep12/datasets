                    ...
                    <tbody>
                        ...
                        foreach ($menunggu->result() as $mg) : ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url('gm/ApproveRequestTambah/approve?id=' . $mg->id . '&kode=1') ?>" onclick="return confirm('Yakin approve ?')" class="badge badge-success">Approved</a>
                                    <a onclick="return confirm('Yakin reject ?')" href="<?= base_url('gm/ApproveRequestTambah/approve?id=' . $mg->id . '&kode=2') ?>" class="badge badge-danger">Reject</a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
