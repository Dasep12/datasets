            ...
            <div class="user-info-dropdown">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="<?= base_url('gm/Password/') ?>"><i class="dw dw-settings2"></i> Ganti Password</a>
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    <li class="dropdown">
                        <a href="<?= base_url('gm/Dashboard') ?>" class="dropdown-toggle no-arrow <?= $uri == 'Dashboard' ? 'active' : '' ?>">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a class="<?= $this->uri->segment(3) == 'list_approve' ? 'active ' : '' ?>" href="<?= base_url('gm/Approved/list_approve') ?>">Approved Plant Budget</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                        ...
                        <ul class="submenu">
                            <li>
                                <a class="<?= $this->uri->segment(3) == 'list_approve_trans' ? 'active ' : '' ?>" href="<?= base_url('gm/Approve_trans/list_approve_trans') ?>">Approval</a>
                            </li>
                            <li>
                                <a class="<?= $this->uri->segment(3) == 'histori_approve_trans' ? 'active ' : '' ?>" href="<?= base_url('gm/Approve_trans/histori_approve_trans') ?>">History</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
