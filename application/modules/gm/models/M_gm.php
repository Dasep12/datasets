...

{
    ...
    public function listTransaksi($dept, $stat)
    {
        ...
        tjp.approve_gm   , tjp.approve_acc , tjp.lampiran_1, tjp.lampiran_2 , tjp.lampiran_3  , tjp.tanggal_request , tjp.ket 
    ...
    public function listVoucher($stat)
    {
        ...
        if ($stat == 0) {
            $where .= "tpv.approve_acc=1 and tpv.approve_gm =0";
        } else {
            $where .= "tpv.approve_acc=1 and tpv.approve_gm=1 or tpv.approve_gm=2";
        }
        ...
        (select nama_lengkap from master_akun where nik = tpv.created_by )as nama, tpv.approve_acc ,tpv.approve_gm ,
