...
class Laporan extends CI_Controller
{
    ...
    public function payment()
    {
        ...
        $this->template->load('template_gm', 'form_laporan_payment', $data);
    }
    ...
    public function panjer()
    {
        ...
        $this->template->load('template_gm', 'form_laporan_panjer', $data);
    }
    ...
    public function apvoucher()
    {
        ...
        $this->template->load('template_gm', 'form_laporan_voucher', $data);
    }
