        ...
        <table class="data-table table hover nowrap">
            ...
            <tbody>
                ...
                foreach ($data->result() as $dpt) : ?>
                    <tr>
                        <td><?= $no++; ?></td>
                        <td><?= strtoupper($dpt->jenis_budget) ?></td>
                        <td>

                            <a href="#" data-toggle="modal" data-target="#edit-data" data-backdrop="static" data-keyboard="false" class="badge badge-success" data-id="<?= $dpt->id ?>" data-jenis_budget="<?= strtoupper($dpt->jenis_budget) ?>"><i class="fa fa-eye"></i></a>

                            <a href="<?= base_url('Admin/JenisBudget/delete?id=' . $dpt->id) ?>" onclick="return confirm('Yakin Hapus ?')" class="badge badge-danger"><i class="fa fa-close"></i></a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
...
<div class="modal fade" id="add-data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?= base_url('Admin/JenisBudget/input') ?>">
...
<div class="modal fade" id="edit-data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?= base_url('Admin/JenisBudget/update') ?>">
                <div class="modal-body">

                    <div class="card-body">
                        <label for="">JENIS BUDGET</label>
                        <input type="hidden" id="id" name="id">
                        <input type="text" autocomplete="off " name="jenis_budget" id="jenis_budget" class="form-control">
                    </div>
