...
class ReportBudget extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template_bc', 'form_report_budget', $data);
    }
    ...
    private function reportRegularPdf($jenis, $tahun, $dept)
    {
        ...
        $mpdf->SetHTMLHeader('<h2 style="position:absolute;left:300px">' . $depat->nama_departement . '<br>BUDGET FY ' . $tahun . '</h2><div style="position:absolute;margin-left:90px;top:-20px;">
        <img style="position:relative;" src="assets/ttd/LOGO.jpg"/>
        </div>');
        $mpdf->AddPage(
            '', // L - landscape, P - portrait 
            '',
