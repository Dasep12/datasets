...
<div class="card-box mb-30">
    ...
    <div class="pb-20">
        <form action="<?= base_url('budgetControl/Approve_trans/multiApprove') ?>" method="post">
            <div class="pd-20">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } else { ?>
                                    ...
                                    <a href="<?= base_url('budgetControl/Approve_trans/approve?id=' . $rm->id_trans . '&kode=1') ?>" onclick="return confirm('Yakin approve ?')" class="badge badge-success">Approved</a>
                                    <a onclick="return confirm('Yakin reject ?')" href="<?= base_url('budgetControl/Approve_trans/approve?id=' . $rm->id_trans . '&kode=2') ?>" class="badge badge-danger">Reject</a>
...
<script>
    $(function() {
        ...
        $('.userinfo').click(function() {
            ...
            // AJAX request
            $.ajax({
                url: "<?= base_url('budgetControl/Approve_trans/viewDetailRaimbes') ?>",
                type: 'post',
                data: {
                    id: userid,
                    'file1': file1,
