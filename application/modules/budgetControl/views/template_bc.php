            ...
            <div class="user-info-dropdown">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="<?= base_url('budgetControl/Password/') ?>"><i class="dw dw-settings2"></i> Ganti Password</a>
                ...
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a class="<?= $this->uri->segment(3) == 'list_approve_lapor' ? 'active ' : '' ?>" href="<?= base_url('budgetControl/Approve_voucher/list_approve_lapor') ?>">Approve Lapor Voucher</a>
                            </li>
                        </ul>
                    </li>
